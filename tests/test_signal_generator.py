...
class TestSignalGenerator(unittest.TestCase):
    ...
    def test_rf_fingerprint(self):
        ...
        signal_no_rf = generate_80211ag_preamble(fs=self.fs, add_rf_fingerprint=False, seed=42)[1]
        ...
        self.assertLess(phase_std, 30, "Phase noise should be within ±25° range")
    ...
    def test_invalid_fs(self):
        ...
        with self.assertRaises(ValueError):
            generate_80211ag_preamble(fs=0, add_rf_fingerprint=False)
        with self.assertRaises(ValueError):
            generate_80211ag_preamble(fs=-1, add_rf_fingerprint=False)
